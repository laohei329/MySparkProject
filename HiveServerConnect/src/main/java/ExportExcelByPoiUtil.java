...
public class ExportExcelByPoiUtil {
    ...
    public static void createExcel(String[] title , int[] widthAttr, Map<String/*sheet名*/,
            List<Map<String/*对应title的值*/, String>>> maps, int[] mergeIndex, Workbook workbook, int startIndex){
        if (title.length==0){
            return ;
        }
     ...
     */
    public static void createExcel(String[] title , int[] widthAttr, Map<String/*sheet名*/,
            List<Map<String/*对应title的值*/, String>>> maps, int[] mergeIndex, Workbook workbook, int startIndex,int sheetnum){
        if (title.length==0){
            return ;
        }
    ...
    public static void createExcelMergeByIndex(String[] title , int[] widthAttr, Map<String/*sheet名*/,
            List<Map<String/*对应title的值*/, String>>> maps, int[] mergeIndex, Workbook workbook, int startIndex,int sheetnum,int mergebyIndex){
        if (title.length==0){
            return ;
        }
